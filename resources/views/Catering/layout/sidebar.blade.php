  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" >
        <ul class="navbar-nav" style="margin-bottom: 30px !important;">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('Catering.BookedHalls') ? 'active bg-gradient-dark text-white' : 'text-dark' }} " style="font-size: 16px;"   href="{{ route('ItemC.Table') }}">
                    <i class="material-symbols-rounded opacity-5">dashboard</i>
                    <span class="nav-link-text ms-1">Catering Items</span>
                </a>
            </li>


            <li class="nav-item mt-3" style="padding: 20px;">
