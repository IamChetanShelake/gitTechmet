...
<body>
    <div class="container mt-5 d-flex justify-content-center">
        <div class="card shadow-lg p-5 w-75">
            <h2 class="text-center mb-4 text-primary">Register New Event Vendor</h2>
            <form action="{{ route('Add.Event') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('firm_name') is-invalid @enderror"
                           id="firm_name" name="firm_name" placeholder="Enter firm name...">
                    @error('firm_name')
                    <span class="invalid-feedback d-block">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('upi_id') is-invalid @enderror"
                           id="upi_id" name="upi_id" placeholder="Enter UPI ID...">
                    @error('upi_id')
                    <span class="invalid-feedback d-block">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('bank_holder_name') is-invalid @enderror"
                           id="bank_holder_name" name="bank_holder_name" placeholder="Enter bank holder name...">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('ifsc') is-invalid @enderror"
                           id="ifsc" name="ifsc" placeholder="Enter IFSC code...">
                    @error('ifsc')
                    <span class="invalid-feedback d-block">{{$message}}</span>
                    @enderror
                </div>
