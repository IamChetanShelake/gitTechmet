...
@section('content')
    <div class="col-12">
        ...
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            {{-- <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3"> --}}
                <div class="shadow-dark border-radius-lg pt-4 pb-3"
                    ...
                    <h6 class="text-white text-capitalize ps-3">Event Vendor Details</h6>
                </div>
        </div>
        {{-- <div>
            <div class="p-3">
        ...
        <div class="d-flex justify-content-end p-3">
            <a class="btn btn-outline-primary btn-lg px-4 py-2"  href="/vieweventadd">Register New Event Vendor</a>
        </div>
            ...
            <table class="table align-items-center mb-0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @endif --}}
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$event->mobile}}</h6>
                        </div>

                    </td>

                    <td class="align-middle text-center text-sm">
                    <a class="btn btn-info" href="{{route('View.Event',$event->id)}}">View</a>
                    </td>
                    ...
                    <a class="btn btn-danger" href="{{route('Delete.Event',$event->id)}}">
                        Delete
                    </a>
