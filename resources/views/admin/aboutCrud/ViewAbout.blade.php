...
<body>
        <div class="container my-5">
            <h1 class="my-3">About Details</h1>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <p><strong>About Title:-</strong> {{ $about->title   }}</p>
                    <p><strong>Description:-</strong> {!! $about->description   !!}</p>

                    <p><strong>Image:</strong></p>
                    @if(isset($about) && $about->image)
                    <img src="{{ asset('About_images/' . $about->image) }}" class="img-fluid" alt="service Image" style="max-width: 400px; height: auto;">
                    @else
