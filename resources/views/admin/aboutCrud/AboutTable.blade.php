...
@section('content')
    <div class="col-12">
        ...
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            {{-- <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3"> --}}
                <div class="shadow-dark border-radius-lg pt-4 pb-3"
                    ...
                    <h6 class="text-white text-capitalize ps-3">About Us Details</h6>
                </div>
        </div>
        {{-- <div>
            <div class="p-3">
        ...
        <div class="d-flex justify-content-end p-3">
            <a class="btn btn-outline-primary btn-lg px-4 py-2"  href="/viewaboutadd">Add About</a>
        </div>
        ...
        <div class="card-body px-0 pb-2">
            ...
            <table class="table align-items-center mb-0">
                ...
                <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                    <a class="btn btn-info" href="{{route('View.About',$about->id)}}">View</a>
                    </td>

                    <td class="align-middle text-center text-sm">
                    <a href="{{route('Edit.About',$about->id)}}" class="btn btn-success" >
                        Edit
                    </a>
                    <a class="btn btn-danger" href="{{route('Delete.about',$about->id)}}">
                        Delete
                    </a>
                    </td>
                    <td class="align-middle text-center">
