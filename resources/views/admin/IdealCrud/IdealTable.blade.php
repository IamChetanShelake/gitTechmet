...
@section('content')
    <div class="col-12">
        ...
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            {{-- <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3"> --}}
                <div class="shadow-dark border-radius-lg pt-4 pb-3"
                    ...
                    <h6 class="text-white text-capitalize ps-3">Ideal For Details</h6>
                </div>
        </div>
        {{-- <div>
            @if(session('success'))
        ...
        <div class="d-flex justify-content-end p-3">
            <a class="btn btn-outline-primary btn-lg px-4 py-2"  href="/viewaddideals">Add Ideal For</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$ideal->title}}</h6>
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$ideal->hall->name}}</h6>
                    ...
                    <td class="align-middle text-center text-sm">
                    <a href="{{route('Edit.Ideal',$ideal->id)}}" class="btn btn-success" >
                        Edit
                    </a>
                    <a class="btn btn-danger" href="{{route('Delete.Ideal',$ideal->id)}}">
                        Delete
                    </a>
                    </td>
                    {{-- <td class="align-middle text-center">
