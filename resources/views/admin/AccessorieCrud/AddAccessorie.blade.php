...
<body>
    <div class="container mt-5 d-flex justify-content-center">
        <div class="card shadow-lg p-4 w-50">
            <h2 class="text-center mb-4 text-primary">Add Accessorie</h2>
            <form action="{{route('Add.Accessorie')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control border rounded-3 shadow-sm ps-3 @error('hours') is-invalid @enderror"
                           id="hours" name="hours" placeholder="Enter Hours" >
                    @error('hours')
                    <span class="invalid-feedback d-block">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="submit" class="btn btn-primary px-4">Add Accessorie</button>
