...
<div class="col-12">
    <div class="card my-4">
      <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
        {{-- <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3"> --}}
            <div class="shadow-dark border-radius-lg pt-4 pb-3"
                ...
                <h6 class="text-white text-capitalize ps-3">Accessories Details</h6>
            </div>
      </div>
      ...
      <div class="d-flex justify-content-end p-3">
        <a class="btn btn-outline-primary btn-lg px-4 py-2"  href="{{route('Accessorie.Add')}}">Add Accessorie</a>
    </div>
              ...
              <tr>
                <td>
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      <h6 class="mb-0 text-sm">{{$accessorie->name}}</h6>
                ...
                {{-- <td>
                    ...
                    <img src="{{ asset('Testomonial_images/' . $test->image) }}" class="avatar avatar-sm me-3 border-radius-lg" alt="Testomonial Image">
                    @else
                ...
                <td class="align-middle text-center text-sm">
                  <a class="btn btn-info" href="{{route('View.Accessorie',$accessorie->id)}}">View</a>
                ...
                <td class="align-middle text-center text-sm">
                    <a href="{{route('Edit.Accessorie',$accessorie->id)}}" class="btn btn-success">
                        Edit
                      </a>
                    <a class="btn btn-danger" href="{{route('Delete.Accessorie',$accessorie->id)}}">
                        Delete
                    </a>
                </td>
              </tr>
