...
<body>
        <div class="container my-5">
            <h1 class="my-3">Landing Page Details</h1>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <p><strong>Landing Page Title:-</strong> {{ $landing->title   }}</p>
                    <p><strong>Description:-</strong> {!! $landing->description   !!}</p>

                    <p><strong>Image:</strong></p>
                    @if(isset($landing) && $landing->image)
                    <img src="{{ asset('Landing_images/' . $landing->image) }}" class="img-fluid" alt="service Image" style="max-width: 400px; height: auto;">
                    @else
