...
<body>
        <div class="container my-5">
            <h1 class="my-3">Our Facilitie Details</h1>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <p><strong>Facilitie Title:-</strong> {{ $ourfacilite->title   }}</p>
                    <p><strong>Description:-</strong> {!! $ourfacilite->description   !!}</p>

                    <p><strong>Image:</strong></p>
                    @if(isset($ourfacilite) && $ourfacilite->image)
                    <img src="{{ asset('OurFacilite_images/' . $ourfacilite->image) }}" class="img-fluid" alt="service Image" style="max-width: 250px; height: auto;">
                    @else
