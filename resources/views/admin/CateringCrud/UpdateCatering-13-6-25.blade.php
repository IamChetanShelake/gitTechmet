...
<body>
    <div class="container mt-5 d-flex justify-content-center">
        <div class="card shadow-lg p-5 w-75">
            <h2 class="text-center mb-4 text-primary">Update Catering Vendor</h2>

            <form action="{{ route('Update.Catering', $catering->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('name') is-invalid @enderror"
                           id="name" name="name" value="{{ old('name', $catering->name) }}" required>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('mobile') is-invalid @enderror"
                           id="mobile" name="mobile" value="{{ old('mobile', $catering->mobile) }}" required>
                    @error('mobile')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('address') is-invalid @enderror"
                           id="address" name="address" value="{{ old('address', $catering->address) }}" required>
                    @error('address')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('city') is-invalid @enderror"
                           id="city" name="city" value="{{ old('city', $catering->city) }}" required>
                    @error('city')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('firm_name') is-invalid @enderror"
                           id="firm_name" name="firm_name" value="{{ old('firm_name', $catering->firm_name) }}" required>
                    @error('firm_name')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control border rounded-3 shadow-sm ps-3 @error('email') is-invalid @enderror"
                           id="email" name="email" value="{{ old('email', $catering->email) }}" required>
                    @error('email')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <label for="upi_id" class="form-label fw-bold">UPI</label>
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('upi') is-invalid @enderror"
                           id="upi" name="upi_id" value="{{ old('upi_id', $catering->upi_id) }}" required>
                    @error('upi')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if($catering->adhar_card)
                        <img src="{{ asset('CateringVendor_images/' . $catering->adhar_card) }}" class="mt-2 img-fluid" style="max-width: 200px;">
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if($catering->pan_card)
                        <img src="{{ asset('CateringVendor_images/' . $catering->pan_card) }}" class="mt-2 img-fluid" style="max-width: 200px;">
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    @if($catering->qr_code)
                        <img src="{{ asset('CateringVendor_images/' . $catering->qr_code) }}" class="mt-2 img-fluid" style="max-width: 200px;">
                    @endif
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('bank_name') is-invalid @enderror"
                           id="bank_name" name="bank_name" value="{{ old('bank_name', $catering->bank_name) }}" placeholder="Enter bank name..." required>
                    @error('bank_name')
                    <span class="invalid-feedback d-block">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('bank_holder_name') is-invalid @enderror"
                           id="bank_holder_name" name="bank_holder_name" value="{{ old('bank_holder_name', $catering->bank_holder_name) }}" placeholder="Enter bank holder name..." required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('account_number') is-invalid @enderror"
                           id="account_number" name="account_number" value="{{ old('account_number', $catering->account_number) }}" placeholder="Enter account number..." required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('ifsc') is-invalid @enderror"
                           id="ifsc" name="ifsc" value="{{ old('ifsc', $catering->ifsc) }}" placeholder="Enter IFSC code..." required>
                    @error('ifsc')
                    <span class="invalid-feedback d-block">{{$message}}</span>
                    @enderror
                </div>
