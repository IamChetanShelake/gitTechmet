            ...
            <form action="{{ route('Update.Catering', $catering->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control border rounded-3 shadow-sm ps-3 @error('alternate_mobile') is-invalid @enderror"
                           id="alternate_mobile" name="alternate_mobile" value="{{ old('alternate_mobile', $catering->alternate_mobile) }}" placeholder="Enter alternate mobile number...">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control border rounded-3 shadow-sm ps-3 @error('upi_id') is-invalid @enderror"
                           id="upi_id" name="upi_id" value="{{ old('upi_id', $catering->upi_id) }}" required>
                    @error('upi_id')
                    <span class="invalid-feedback d-block">{{ $message }}</span>
                    @enderror
                </div>
