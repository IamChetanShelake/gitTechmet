...
<body>
        <div class="container my-5">
            <h1 class="my-3">Hall Page Details</h1>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <p><strong>Hall Name :-</strong> {{ $hallpage->hall->name   }}</p>
                    <p><strong>Page Title:-</strong> {{ $hallpage->title   }}</p>
                    <p><strong>Description:-</strong> {!! $hallpage->description   !!}</p>
