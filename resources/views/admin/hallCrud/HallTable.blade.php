...
@section('content')
    <div class="col-12">
        ...
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            {{-- <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3"> --}}
                <div class="shadow-dark border-radius-lg pt-4 pb-3"
                    ...
                    <h6 class="text-white text-capitalize ps-3">Hall Details</h6>
                </div>
        </div>
        {{-- <div>
        ...
        <div class="d-flex justify-content-end p-3">
            <a class="btn btn-outline-primary btn-lg px-4 py-2"  href="{{route('halls.create')}}">Add Hall</a>
        </div>
            ...
            <table class="table align-items-center mb-0">
                ...
                <tr>
                    ...
                    <div class="d-flex px-2 py-1">
                        ...
                        <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">{{$hall->name}}</h6>
                    ...
                    <td>
                        ...
                        <img src="{{ asset('Hall_images/' . $hall->image) }}" class="avatar avatar-sm me-3 border-radius-lg" alt="Hall Image">
                        @else
                    ...
                    <td class="align-middle text-center text-sm">
                    <a class="btn btn-info" href="{{route('halls.show',$hall->id)}}">View</a>
                    </td>

                    <td class="align-middle text-center text-sm">
                    <a href="{{route('halls.edit',$hall->id)}}" class="btn btn-success" >
                        Edit
                    </a>
                    {{-- <a class="btn btn-danger" href="{{route('halls.destroy',$hall->id)}}">
                        Delete
                    </a> --}}
