...
<body>
        <div class="container my-5">
            <h1 class="my-3">Facilitie Details</h1>
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <p><strong>Facilitie Title:-</strong> {{ $facilite->title   }}</p>
                    <p><strong>Description:-</strong> {!! $facilite->description   !!}</p>

                    <p><strong>Image:</strong></p>
                    @if(isset($facilite) && $facilite->image)
                    <img src="{{ asset('Facilitie_images/' . $facilite->image) }}" class="img-fluid" alt="service Image" style="max-width: 250px; height: auto;">
                    @else
